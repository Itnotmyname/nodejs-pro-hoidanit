...
const passwordSchema =
    z.string().min(3, { message: "Password tối thiểu 3 ký tự" })
...
//     message: "Password bao gồm ít nhất 1 ký tự đặc biết",
// });
...
const emailSchema =
    z.string().email("Email không đúng định dạng").refine(async (email) => {
